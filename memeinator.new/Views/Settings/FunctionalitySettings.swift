        ...
        Form {
            ...
            Section("Analytics") {
                VStack {
                    ...
                    Text("Google Analytics helps us understand how we can improve Memeinator. We understand that not everybody likes Google Analytics, so you can disable it if you'd like. You can always change this later in settings.")
                        .font(.footnote)
                }
            }
